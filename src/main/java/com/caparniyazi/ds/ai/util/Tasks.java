 ...
 */
public class Tasks {
    // simple API to act cancellable tasks in background - functionality is provided by three functional attributes.
    ...
    /**
     * Tests whether the current task has been canceled.
     * Calls of this method can be placed anywhere in the code.
    ...
    /**
     * Executes a given task in the background.
     */
